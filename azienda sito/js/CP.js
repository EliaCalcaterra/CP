...
function creaCardDipendente(dipendente) {
    ...
    card.innerHTML = `
        ...
        <div class="azioni">
            <button class="btn btn-sm btn-outline-primary" onclick="modificaDipendente(${dipendente.id})" title="Modifica dipendente">
                <i class="fas fa-edit"></i> Modifica
            </button>
            <button class="btn btn-sm btn-outline-danger" onclick="eliminaDipendente(${dipendente.id})" title="Elimina dipendente">
...
function creaCardProdotto(prodotto) {
    ...
    card.innerHTML = `
        <h6>${prodotto.nome}</h6>
        <div class="quantita">${prodotto.quantita} unità</div>
        <div class="azioni">
            <button class="btn btn-sm btn-outline-primary" onclick="modificaProdotto(${prodotto.id})">
                <i class="fas fa-edit"></i>
            </button>
            <button class="btn btn-sm btn-outline-danger" onclick="eliminaProdotto(${prodotto.id})">
